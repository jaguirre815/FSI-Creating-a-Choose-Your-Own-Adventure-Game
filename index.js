...
if (firstAnswer === 'left'){
    ...
    if (secondAnswer ==='follow'){
        ...
        if (thirdanswer ==='stay'){
            ...
            window.prompt('After leavin the cat colony, you are never able to find it again, without proof, no one believes your story which passes into legend nonetheless')
    ...
    if(secondAnswer === 'continue'){
        ...
        if(thirdAnswer === 'ladder'){
            ...
            window.alert('After ascending the staircase, you discover a shinny blue stone, which you take home and cherish forever.')
        } 
    }
}           

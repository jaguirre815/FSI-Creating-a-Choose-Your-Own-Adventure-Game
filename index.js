    ...
    if(firstAnswer === 'left'){
                    ...
                    if(secondAnswer ==='follow it'){
                            let thirdAnswer = window.prompt('You follow the cat to a colony of cats, nestled in a fort of warm blankets and subsisting off of inexplicably warm soup. They are content with you staying, but you wonder if you should alert the world to this magical safe haven.')
                                    ...
                                    }else(thirdAnswer === 'spread the word') }
                                        let fifthhAnswer = window.alert('After leaving the cat colony, you are never able to find it again; without proof, no one believes your story, which passes into legend nonetheless.')
                    }else(secondAnswer === 'continue')
                            let thirdAnswer = window.alert('You come across a chamber that reaches upward to a shining light above. There is a long, winding staircase, and a much quicker, but rickety-looking ladder that leads up toward the light. Which do you take?')
                    ...
                    let thirdAnswer = window.prompt('The dragon wakes up and sits upright. You only have a moment to respond, to stay or run:')
                                        ...
                                        let fourthhAnswer = window.alert('Quickly, you run back to the cave entrance. Sheepish, you return home.')
                    if(secondAnswer === 'away from the dragon')
                            let thirdAnswer = window.alert('After walking a while longer, you come across a shiny blue flower. It is so beautiful that you decide you must either draw it or pick it. Which do you do?')
